...
.travel-vaccine-card {
    background: white; border: 1px solid #eef0f2; border-radius: 18px; padding: 28px;
...
<section class="travel-hero">
    <div class="container">
        ...
        <h1 class="display-4 fw-bold mb-3" style="color:#da7215;">Travel Vaccines</h1>
        <p class="lead" style="color:#6b7280;max-width:640px;">Meet entry requirements for pilgrimage (Hajj &amp; Umrah) and international travel, with certified documentation.</p>
        ...
        <div class="row g-4">
            ...
            <?php else : ?>
                <div class="col-12 text-center py-5">
                    <i class="bi bi-airplane" style="font-size: 64px; color: #e5e7eb;"></i>
