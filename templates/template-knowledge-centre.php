 ...
 * rather than a chronological blog feed. Disease reference pages (Pods
 * post type `disease`) are a separate section — see /diseases — but an
 * article here can link out to a matching Disease page in its own body
 * when relevant.
 */
get_header();
