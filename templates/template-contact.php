    ...
    <div class="container" style="position: relative; z-index: 1;">
        <div class="row">
            <div class="col-lg-8 mx-auto text-center">
                ...
                <h1 class="display-4 fw-bold mb-3" style="color: #0b5c87;">Get In Touch</h1>
                <p class="lead" style="color: #4a575e;">We're here to help. Reach out to us for any queries or to book an appointment.</p>
            </div>
        </div>
    </div>
</section>
    ...
    <div class="container">
        <div class="row g-4">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="contact-card text-center p-4 h-100" style="background: linear-gradient(135deg, #f6f3ec, #efe9db); border-radius: 20px; transition: all 0.3s;">
                    <div class="icon-wrapper mb-4" style="width: 80px; height: 80px; margin: 0 auto; background: #0a2a38; border-radius: 50%; display: flex; align-items: center; justify-content: center; box-shadow: 0 8px 25px rgba(10, 42, 56, 0.3);">
                        <i class="bi bi-telephone-fill" style="font-size: 36px; color: white;"></i>
                    </div>
                    <h5 class="fw-bold mb-3" style="color: #16232b;">Call Us</h5>
                    <p class="text-muted mb-3">Mon - Sun: 9:00 AM - 8:00 PM</p>
                    <a href="tel:<?php echo esc_attr($phone_link); ?>" class="d-block fw-bold mb-2" style="color: #0b5c87; text-decoration: none; font-size: 20px;">
                        <?php echo esc_html($phone); ?>
                    </a>
                    <a href="tel:<?php echo esc_attr($phone_link); ?>" class="btn btn-sm" style="background: #0b5c87; color: white; border-radius: 50px; padding: 8px 24px;">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="contact-card text-center p-4 h-100" style="background: linear-gradient(135deg, #eaf3e4, #dcedd0); border-radius: 20px; transition: all 0.3s;">
                    ...
                    <h5 class="fw-bold mb-3" style="color: #16232b;">WhatsApp</h5>
            ...
            <!-- Email -->
            <div class="col-lg-4 col-md-6">
                <div class="contact-card text-center p-4 h-100" style="background: linear-gradient(135deg, #eaf2f6, #cfe0e8); border-radius: 20px; transition: all 0.3s;">
                    <div class="icon-wrapper mb-4" style="width: 80px; height: 80px; margin: 0 auto; background: #0b5c87; border-radius: 50%; display: flex; align-items: center; justify-content: center; box-shadow: 0 8px 25px rgba(11, 92, 135, 0.3);">
                        <i class="bi bi-envelope-fill" style="font-size: 36px; color: white;"></i>
                    </div>
                    <h5 class="fw-bold mb-3" style="color: #16232b;">Email Us</h5>
                    <p class="text-muted mb-3">We'll respond within 24 hours</p>
                    <a href="mailto:<?php echo esc_attr($email); ?>" class="d-block fw-bold mb-2" style="color: #0b5c87; text-decoration: none; font-size: 18px; word-break: break-all;">
                        <?php echo esc_html($email); ?>
                    </a>
                    <a href="mailto:<?php echo esc_attr($email); ?>" class="btn btn-sm" style="background: #0b5c87; color: white; border-radius: 50px; padding: 8px 24px;">
        ...
        <div class="row g-5">
            ...
            <div class="col-lg-8">
                <div class="bg-white p-5 rounded-4 shadow-sm">
                    <div class="mb-4">
                        <h2 class="fw-bold mb-3" style="color: #0b5c87;">Send Us a Message</h2>
            ...
            <div class="col-lg-4">
                ...
                <div class="bg-white p-4 rounded-4 shadow-sm mb-4">
                    <h5 class="fw-bold mb-4" style="color: #0b5c87;">
                        <i class="bi bi-clock-fill" style="color: #c9a24b;"></i> Office Hours
                    </h5>
                ...
                <div class="bg-white p-4 rounded-4 shadow-sm mb-4">
                    <h5 class="fw-bold mb-4" style="color: #0b5c87;">
                        <i class="bi bi-geo-alt-fill" style="color: #0b5c87;"></i> Service Areas
                    </h5>
                    <?php
                ...
                <div class="bg-white p-4 rounded-4 shadow-sm">
                    <h5 class="fw-bold mb-4" style="color: #0b5c87;">
                        <i class="bi bi-share-fill" style="color: #0b5c87;"></i> Follow Us
                    </h5>
...
<section class="py-5" style="background: white;">
    <div class="container">
        <div class="text-center mb-5">
            <h2 class="fw-bold mb-3" style="color: #0b5c87;">Find Us</h2>
...
<!-- ================= FAQ SECTION ================= -->
<section class="py-5" style="background: linear-gradient(135deg, #f6f3ec 0%, #efe9db 100%);">
    <div class="container">
        <div class="text-center mb-5">
            <h2 class="fw-bold mb-3" style="color: #0b5c87;">Common Questions</h2>
                    ...
                    <div class="accordion-item mb-3 border-0 rounded-3 overflow-hidden shadow-sm">
                        <h2 class="accordion-header">
                            <button class="accordion-button fw-bold" type="button" data-bs-toggle="collapse" data-bs-target="#faq1">
                                <i class="bi bi-question-circle-fill me-2" style="color: #0b5c87;"></i>
...
<!-- ================= CTA SECTION ================= -->
<section class="py-5" style="background: #0a2a38;">
    <div class="container">
        <div class="row align-items-center text-white">
            <div class="col-lg-8 mb-4 mb-lg-0">
                <h2 class="fw-bold mb-3">Ready to Book Your Vaccination?</h2>
                <p class="mb-0 fs-5" style="color: #a9bac2;">Don't wait! Protect your family's health with our professional home vaccination service.</p>
            </div>
            <div class="col-lg-4 text-lg-end">
                <a href="<?php echo home_url('/booking'); ?>" class="btn btn-lg px-5 fw-bold" style="border-radius: 50px; background: #c9a24b; color: #0a2a38;">
