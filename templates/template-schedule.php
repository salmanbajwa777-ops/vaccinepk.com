...
.schedule-stage {
    position: relative; background: white; border: 1px solid var(--color-sand); border-radius: 16px;
...
.schedule-stage::before {
    ...
    border-radius: 50%; background: #0b5c87; border: 3px solid white; box-shadow: 0 0 0 2px #0b5c87;
}
.schedule-stage h3 { color: #0b5c87; font-weight: 700; margin-bottom: 12px; }
.schedule-vaccine-chip {
    display: inline-flex; align-items: center; gap: 6px; padding: 8px 16px;
    border-radius: 50px; background: var(--color-blue-tint); border: 1.5px solid #0b5c87;
    color: #0b5c87; font-weight: 600; font-size: 0.85rem; text-decoration: none;
    margin: 0 8px 8px 0;
}
.schedule-vaccine-chip:hover { background: #0b5c87; color: white; }
.schedule-vaccine-chip.no-link { cursor: default; border-color: var(--color-sand); color: var(--color-label-muted); }
</style>
...
<section class="schedule-hero">
    <div class="container">
        ...
        <h1 class="display-4 fw-bold mb-3" style="color:#0b5c87;">Pakistan Vaccination Schedule</h1>
        <p class="lead" style="color:#4a575e;max-width:640px;">The recommended childhood immunization timeline, from birth through 18 months, following EPI guidelines.</p>
    </div>
</section>
